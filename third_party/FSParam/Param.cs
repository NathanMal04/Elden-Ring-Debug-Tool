...
public class Param : SoulsFile<Param>
{
    ...
    public void ApplyParamdef(PARAMDEF def, ulong regulationVersion = ulong.MaxValue)
    {
        ...
        {
            // [Erd-Tools fork] Dropped DSMapStudio regulation-version field filtering
            // (def.VersionAware / field.IsValidForRegulationVersion) — those members don't
            // exist in Nordgaren's SoulsFormats. All fields are treated as valid.
    ...
    protected override void Write(BinaryWriterEx bw)
    {
        ...
        for (var i = 0; i < Rows.Count; i++)
        {
            ...
            bw.WriteBytes(data.ToArray()); // [Erd-Tools fork] Nordgaren SoulsFormats' WriteBytes takes byte[], not Span<byte>
        }
